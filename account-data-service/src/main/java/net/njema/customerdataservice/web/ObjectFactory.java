 ...
 * generated in the net.njema.customerdataservice.web package. 
...
public class ObjectFactory {
    ...
    private final static QName _CustomerById_QNAME = new QName("http://web.customerdataservice.njema.net/", "customerById");
    private final static QName _CustomerByIdResponse_QNAME = new QName("http://web.customerdataservice.njema.net/", "customerByIdResponse");
    private final static QName _CustomerList_QNAME = new QName("http://web.customerdataservice.njema.net/", "customerList");
    private final static QName _CustomerListResponse_QNAME = new QName("http://web.customerdataservice.njema.net/", "customerListResponse");
    private final static QName _SaveCustomer_QNAME = new QName("http://web.customerdataservice.njema.net/", "saveCustomer");
    private final static QName _SaveCustomerResponse_QNAME = new QName("http://web.customerdataservice.njema.net/", "saveCustomerResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.njema.customerdataservice.web
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.njema.net/", name = "customerById")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.njema.net/", name = "customerByIdResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.njema.net/", name = "customerList")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.njema.net/", name = "customerListResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.njema.net/", name = "saveCustomer")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.njema.net/", name = "saveCustomerResponse")
